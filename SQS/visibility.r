...
**************************
    - After a message is pulled or viewed by a consumer, it becomes invisible from other consumers 
    ...
    - If a consumer can not consume a message in the 30 seconds time periuod, then use the ChangeMessageVisibility 
      API to change this
