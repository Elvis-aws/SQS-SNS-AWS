...
*****************
    ...
    *******
        ...
        - Amazon SQS doesnt support filtering and modifying messages while redriving them from the dead-letter 
          queue
        - A dead-letter queue redrive task can run a maximum of 36 hours
        - Amazon SQS supports a maximum of 100 active redrive tasks per account
        - A new messageID and enqueueTime are assigned to redriven messages